declare module Scandit {
  ...
  export class BarcodePicker {
    ...
    setMargins(
      portraitMargins: Margins,
      landscapeMargins: Margins,
      animationDuration: number
    ): void;
    pauseScanning(): void;
    resumeScanning(): void;
  ...
  export class ScanCase {
    static acquire(
      ...
      callbacks: ScanCase.CaseCallbacks
    ): ScanCase;
    ...
    setTimeout(
      timeout: number,
      fromState: ScanCase.State,
      toState: ScanCase.State
    ): void;
  }
  ...
  export class ScanOverlay {
    ...
    setCameraSwitchVisibility(
      visibility: ScanOverlay.CameraSwitchVisibility
    ): void;
    setCameraSwitchButtonMarginsAndSize(
      rightMargin: number,
      topMargin: number,
      width: number,
      height: number
    ...
    setMissingCameraPermissionInfoText(
      missingCameraPermissionInfoText: string
    ): void;
    updateOverlayIfExists(): void;
    setMatrixScanHighlightingColor(
      state: ScanOverlay.MatrixScanState,
      hexCode: string
    ): void;
  }
